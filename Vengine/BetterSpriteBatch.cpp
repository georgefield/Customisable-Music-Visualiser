...
BetterSpriteBatch::SpriteBatch() : _vbo(0), _vao(0)
{}
...
void BetterSpriteBatch::begin(GlyphSortType sortType) {
	_sortType = sortType;
...
void BetterSpriteBatch::draw(const glm::vec4& destRect, const glm::vec4& uvRect, const GLuint& texture, const float& depth, const ColourRGBA8& colour) { //adds glyph to vector of glyphs
...
bool BetterSpriteBatch::compareFrontToBack(Glyph* a, Glyph* b) {
	return (a->depth < b->depth);
}
bool BetterSpriteBatch::compareBackToFront(Glyph* a, Glyph* b) {
	return (a->depth > b->depth);
}
bool BetterSpriteBatch::compareTexture(Glyph* a, Glyph* b) {
...
void BetterSpriteBatch::sortGlyphs() {
